#!/bin/sh
#SBATCH --job-name=SKYv6_SKY
#SBATCH --cpus-per-task=16
#SBATCH --ntasks=1
#SBATCH --time=0:40:00
#SBATCH --partition=shared-gpu,private-dpnc-gpu
#SBATCH --nodes=1
#SBATCH --output=/home/users/o/oleksiyu/WORK/skycurtains/transit/jobs/job_output/TRANSITvSKYv6_SKY-%A-%x_%a.out
#SBATCH --mem=16GB
#SBATCH --gres=gpu:1
...
singularity exec --nv -B /home/users/,/srv,/tmp /srv/beegfs/scratch/groups/rodem/skycurtains/containers/skyCurtains.sif \
 ...
 --config-name TRANSITvSKYv6_SKY general.subfolder=SKY/"
